...
namespace gestaoContadorcomvc.Models.Autenticacao
{
    ...
    {        
        ...
        public Usuario buscaUsuarioLogin(string usuario, string senha)
        {
            ...
            permissoes = permissoes.listaPermissoes(user.usuario_id);
            user._permissoes = permissoes;
        ...
        public string novoUsuario(string nome, string dcto, string usuario, string senha, int conta_id, string email, string permissoes, int usuario_id, Permissoes _permissoes)
        {
            ...
            try
            {
                ...
                //12/12/2021
                comando.Parameters.AddWithValue("SCI_ilc", _permissoes.SCI_ilc);
                comando.Parameters.AddWithValue("SCI_id", _permissoes.SCI_id);
                comando.Parameters.AddWithValue("area_empresa_contador", _permissoes.area_empresa_contador);
                //24/12/2021
                comando.Parameters.AddWithValue("rfm", _permissoes.rfm);
                //03/03/2021
                comando.Parameters.AddWithValue("cartaoCreditoList", _permissoes.cartaoCreditoList);
                comando.Parameters.AddWithValue("cartaoCreditoCreate", _permissoes.cartaoCreditoCreate);
                comando.Parameters.AddWithValue("cartaoCreditoEdit", _permissoes.cartaoCreditoEdit);
                comando.Parameters.AddWithValue("cartaoCreditoDelete", _permissoes.cartaoCreditoDelete);
                //27/03/2021
                comando.Parameters.AddWithValue("rpList", _permissoes.rpList);
                //28/04/2021
                comando.Parameters.AddWithValue("centro_custoCreate", _permissoes.centro_custoCreate);
                comando.Parameters.AddWithValue("centro_custoDelete", _permissoes.centro_custoDelete);
                comando.Parameters.AddWithValue("centro_custoEdit", _permissoes.centro_custoEdit);
                comando.Parameters.AddWithValue("centro_custoList", _permissoes.centro_custoList);
                //03/05/2021
                comando.Parameters.AddWithValue("riopList", _permissoes.riopList);
                comando.ExecuteNonQuery();
        ...
        public string alteraUsuario(string nome, string dcto, int conta_id, string email, string permissoes, int usuario_id, int usuarioLogado, Permissoes _permissoes)
        {
            ...
            try
            {
                comando.CommandText = "UPDATE usuario set usuario_nome = @usuario_nome, usuario_dcto = @usuario_dcto, usuario_email = @usuario_email, usuario_permissoes = @usuario_permissoes, riopList = @riopList where usuario_id = @usuario_id;";
                comando.Parameters.AddWithValue("@usuario_nome", nome);
                comando.Parameters.AddWithValue("@usuario_dcto", dcto);                
                comando.Parameters.AddWithValue("@usuario_email", email);
                comando.Parameters.AddWithValue("@usuario_permissoes", permissoes);
